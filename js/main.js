...
$(listObj).click(function() { // click a button, get related gifs
...
$('#topicSubmit').click(function() { // add topic from user input
    let newTopic = $('#topicText').val();
    myListAZ.push(newTopic);
    makeButtons();
});

$(buttonClear).click(function() { // clear gif if clicked
    clearGifs();
})

// does not work
$(gifImg).click(function() { // swap gif with jpg
